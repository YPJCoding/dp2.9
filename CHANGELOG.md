...
- Frida/JS migration status is tracked in `docs/FRIDA_MIGRATION_STATUS.md`; `drop_announce` remains a known gap because no source-equivalent implementation was found.
